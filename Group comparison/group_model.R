...
# Save model
saveRDS(fit,
        file="Group comparison/group_model.rda",
        compress="xz")
...
samps <- brms::posterior_samples(fit, "b_|sigma") # It saves all the samples from the model.

write_csv(samps, "Group comparison/group_model_posterior.csv")
